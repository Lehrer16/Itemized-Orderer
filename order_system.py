def place_order(menu):
    ...
    while True:
        ...
        menu_selection = input("Enter the menu item number you want to order: ")
...
def update_order(order, menu_selection, menu_items):
    ...
    if menu_selection.isdigit():
        ...
        if menu_selection in menu_items:
            ...
            print(f"Menu selection {menu_selection} is not valid. Please select a valid menu item.")
    else:
        print(f"Input {menu_selection} is not valid. Please enter a number.")
